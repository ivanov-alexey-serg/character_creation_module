...
def attack(char_name: str, char_class: str) -> str:
    """Return a string with the damage value."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return a string with the value of the blocked damage."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return a string with the applied special skill."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Display the selected character and the result of user commands."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Return a string with the selected character."""
    approve_choice: str = ''
    char_class: str = ''
